...
public class LinkedLists extends Base{
...
public void editorlist1fn() throws IOException
{
	...
	driver.findElement(editorlist1).sendKeys(listcode1);
}
...
public void editorlist2fn() throws IOException
{
	...
	driver.findElement(editorlist2).sendKeys(listcode2);
}
...
public void editorlist3fn() throws IOException
{
	...
	driver.findElement(editorlist3).sendKeys(listcode3);
}
...
public void editorlist4fn() throws IOException
{
	...
	driver.findElement(editorlist4).sendKeys(listcode4);
}
...
public void editorlist5fn() throws IOException
{
	...
	driver.findElement(editorlist1).sendKeys(listcode5);
}
...
public void editorlist6fn() throws IOException
{
	...
	driver.findElement(editorlist6).sendKeys(listcode6);
}
...
public void editorlist7fn() throws IOException
{
	...
	driver.findElement(editorlist1).sendKeys(listcode7);
}
